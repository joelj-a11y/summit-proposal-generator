#!/usr/bin/env python3
"""
Summit Proposal Generator - Render Deployment
...
<body>
    <div class="container">
        <h1>📄 Summit Proposal Generator</h1>
        <p class="subtitle">Upload quote data to generate Word proposal</p>
        ...
        <div class="instructions">
            <h3>📋 How to use:</h3>
            <ol>
                <li>Generate a quote in the Quote Calculator</li>
                <li>Click "Download Quote Data" to save the JSON file</li>
                <li>Upload the JSON file here (click or drag & drop)</li>
    ...
    <script>
        ...
        generateBtn.addEventListener('click', async () => {
            ...
            try {
                ...
                showStatus('processing', '⏳ Generating proposal... (may take 30 sec on first use)');
...
# NOTE: Template needs to be uploaded - this is a placeholder
# You'll upload the template through Render dashboard
TEMPLATE_DATA = None
...
def generate_proposal_docx(quote_data):
    ...
    template_path = 'Enhanced_Pricing_Template_Blank__2_.docx'
    if not os.path.exists(template_path):
        raise Exception("Template file not found. Please upload it to the server.")
    ...
    if len(tables) < 2:
        raise Exception("Template format error")
